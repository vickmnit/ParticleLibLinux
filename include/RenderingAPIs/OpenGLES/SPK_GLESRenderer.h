...
#ifndef H_SPK_GLESRENDERER
#define H_SPK_GLESRENDERER
...
namespace GLES
{
	/**
	* @class GLESRenderer
	* @brief An abstract Renderer for the openGLES renderers
	*/
	class SPK_GL_PREFIX GLESRenderer : public Renderer
	{
	public :
		...
		/** @brief Constructor of GLESRenderer */
		GLESRenderer();
		...
		/** @brief Destructor of GLESRenderer */
	...
	inline void GLESRenderer::enableBlending(bool blendingEnabled)
	{
		this->blendingEnabled = blendingEnabled;
	}

	inline void GLESRenderer::setBlendingFunctions(GLuint src,GLuint dest)
	{
		srcBlending = src;
		destBlending = dest;
	}

	inline void GLESRenderer::setTextureBlending(GLuint textureBlending)
	{
		this->textureBlending = textureBlending;
	}

	inline bool GLESRenderer::isBlendingEnabled() const
	{
		return blendingEnabled;
	}

	inline GLuint GLESRenderer::getSrcBlendingFunction() const
	{
		return srcBlending;
	}

	inline GLuint GLESRenderer::getDestBlendingFunction() const
	{
		return destBlending;
	}

	inline GLuint GLESRenderer::getTextureBlending() const
	{
		return textureBlending;
	}

	inline void GLESRenderer::initBlending() const
	{
		if (blendingEnabled)
		{
	...
	inline void GLESRenderer::initRenderingHints() const
	{
		// alpha test: to apply this in fragment shader as:
